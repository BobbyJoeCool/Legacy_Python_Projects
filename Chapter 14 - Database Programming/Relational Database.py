...
from db_functions import (add_department, add_major, add_student,
                          delete_department, delete_major, delete_student,
                          get_departments, get_dept_id, get_major_id,
                          get_majors, get_student_id, get_students,
                          list_departments, list_majors, list_students,
                          search_department, search_major, search_student,
                          update_department, update_major, update_student)
...
def db_major():
    ...
    majorMenu = tk.OptionMenu(
        menuFrame, menu, *menuList, command=lambda _: menu_change()
    )
    ...
    def menu_change():
        ...
        if entry == menuList[0]:  # Add a new Major
            ...
            def submit():
                ...
                if result == True:
                    messagebox.showinfo(
                        "Success!", f"Added {major} to available majors."
                    )
                elif result == False:
                    messagebox.showinfo(
                        "Failure!", "That major already exists, try again."
                    )
            ...
            majorLabel = tk.Label(
                mainFrame, text="Enter the Major you are searching for: "
            )
            majorLabel.grid(column=0, row=0)
            majorEntry = tk.Entry(mainFrame, textvariable=majorName)
            majorEntry.grid(column=1, row=0)
            ...
            def submit():
                ...
                if result == False:
                    messagebox.showinfo(
                        "Failure!", f"The major {oMajor} does not exist."
                    )
                else:
                    messagebox.showinfo(
                        "Success!", f"The major {oMajor} has been updated to {nMajor}."
                    )
                    menu_change()
            ...
            def submit():
                ...
                if result == False:
                    messagebox.showinfo(
                        "Failure!", f"The major {major} does not exist."
                    )
                else:
                    messagebox.showinfo(
                        "Success!", f"The major {major} has been removed."
                    )
                    menu_change()
    ...
    def menu_change():
        ...
        if entry == menuList[0]:  # Add a new Department
            ...
            def submit():
                ...
                if dept == "":
                    messagebox.showinfo(
                        "Failure!", "You did not enter a department to add."
                    )
                    return
                result = add_department(dept)
                if result == True:
                    messagebox.showinfo(
                        "Success!", f"Added {dept} to available department."
                    )
                elif result == False:
                    messagebox.showinfo(
                        "Failure!", "That department already exists, try again."
                    )
            ...
            # Enter a Major to Search For
            deptLabel = tk.Label(
                mainFrame, text="Enter the department you are searching for: "
            )
            deptLabel.grid(column=0, row=0)
            deptEntry = tk.Entry(mainFrame, textvariable=deptName)
            deptEntry.grid(column=1, row=0)
            ...
            # Select an old Major to edit
            oldLabel = tk.Label(
                mainFrame, text="Select the department you want to change:"
            )
            ...
            # Rename the Major
            newLabel = tk.Label(
                mainFrame, text="Enter the new name for the department:"
            )
            ...
            def submit():
                ...
                if result == False:
                    messagebox.showinfo(
                        "Failure!", f"The department {oDept} does not exist."
                    )
                else:
                    messagebox.showinfo(
                        "Success!",
                        f"The department {oDept} has been updated to {nDept}.",
                    )
                    menu_change()
            ...
            # Select an old Major to edit
            delLabel = tk.Label(
                mainFrame, text="Select the department you want to delete:"
            )
            ...
            def submit():
                ...
                if result == False:
                    messagebox.showinfo(
                        "Failure!", f"The department {dept} does not exist."
                    )
                else:
                    messagebox.showinfo(
                        "Success!", f"The department {dept} has been removed."
                    )
                    menu_change()
            ...
            tk.Label(
                mainFrame, textvariable=deptListString, justify="left", font=("courier")
            ).pack()
    ...
    def menu_change():
        ...
        if entry == menuList[0]:  # Add a new Student
            ...
            def submit():
                ...
                if stud == "":
                    messagebox.showinfo(
                        "Failure!", "You did not enter a student to add."
                    )
                    return
                ...
                if result == True:
                    messagebox.showinfo(
                        "Success!",
                        f"Added {stud} with a major of {major} in the {dept} department.",
                    )
                elif result == False:
            ...
            studLabel = tk.Label(
                mainFrame, text="Enter the student you are searching for: "
            )
            ...
            oldLabel = tk.Label(
                mainFrame, text="Select the student you want to change:"
            )
            oldSelect = tk.OptionMenu(
                mainFrame, studentName, *students, command=lambda _: change_student()
            )
            oldLabel.grid(column=0, row=0)
            oldSelect.grid(column=1, row=0)
            ...
            newStudLabel = tk.Label(
                mainFrame, text="Enter the new name for the student: "
            )
            ...
            newMajorLabel = tk.Label(
                mainFrame, text="Select a new major (keep for no change):"
            )
            ...
            newDeptLabel = tk.Label(
                mainFrame, text="Select a new department (keep for no change):"
            )
            ...
            def submit():
                ...
                if result == False:
                    messagebox.showinfo(
                        "Failure!", f"The student {oStudent} does not exist."
                    )
                else:
                    messagebox.showinfo(
                        "Success!",
                        f"The {oStudent} has been updated:\nStudent ID: {studID}\nName: {nStudent}\nMajor: {major}\n Department: {dept}",
                    )
                    menu_change()
            ...
            delLabel = tk.Label(
                mainFrame, text="Select the student you want to delete:"
            )
            ...
            def submit():
                ...
                if result == False:
                    messagebox.showinfo(
                        "Failure!", f"The student {student} does not exist."
                    )
                else:
                    messagebox.showinfo(
                        "Success!", f"The student {student} has been removed."
                    )
                    menu_change()
            ...
            tk.Label(
                mainFrame, textvariable=studListString, justify="left", font=("courier")
            ).pack()
