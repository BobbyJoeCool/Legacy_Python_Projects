...
class BaseGUI:
    ...
    def imTab(self):
        messagebox.showinfo(
            "Success", "You pressed the Inventory Manager Functions Button"
        )
    ...
    def omTab(self):
        messagebox.showinfo(
            "Success", "You pressed the Operations Manager Functions Button"
        )
    ...
    def createButtons(self):
        wwButton = ttk.Button(
            self.buttonFrame, text="Warehouse Worker Functions", command=self.wwTab
        )
        wwButton.pack(side="left", expand=True, fill="x", padx=2, pady=5)
        imButton = ttk.Button(
            self.buttonFrame, text="Inventory Manager Functions", command=self.imTab
        )
        imButton.pack(side="left", expand=True, fill="x", padx=2, pady=5)
        locButton = ttk.Button(
            self.buttonFrame, text="Warehouse Location Functions", command=self.locTab
        )
        locButton.pack(side="left", expand=True, fill="x", padx=2, pady=5)
        omButton = ttk.Button(
            self.buttonFrame, text="Operations Manger Functions", command=self.omTab
        )
