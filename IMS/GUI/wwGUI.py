...
class WarehouseWorkerGUI:
    ...
    def buildPIP(self):
        ...
        palletLocDisplay = ttk.Label(
            pipFrame, textvariable=palletLoc, width=10, font=self.bold_font
        )
        ...
        palletQuantityDisplay = ttk.Label(
            pipFrame, textvariable=palletQuantity, width=3
        )
        ...
        pullStatusLabel = ttk.Label(
            pipFrame, textvariable=pullStatus, anchor="center", font=self.bold_font
        )
    ...
    def buildSDP(self):
        ...
        palletIDEntry = ttk.Entry(
            sdpFrame, textvariable=palletID, width=8, font=self.bold_font
        )
        assignedLocationLabel = ttk.Label(
            sdpFrame, text="Assigned Location:", font=self.bold_font
        )
        assignedLocationDisplay = ttk.Label(
            sdpFrame, textvariable=assignedLoc, font=self.bold_font
        )
        ...
        palletItemQuantityDisplay = ttk.Label(
            sdpFrame, textvariable=palletItemQuantity, width=3
        )
        ...
        displayMessageLabel = ttk.Label(
            sdpFrame, textvariable=displayMessage, anchor="center", font=self.bold_font
        )
    ...
    def buildMDP(self):
        ...
        palletIDEntry = ttk.Entry(
            mdpFrame, textvariable=palletID, width=8, font=self.bold_font
        )
        ...
        palletItemQuantityDisplay = ttk.Label(
            mdpFrame, textvariable=palletItemQuantity, width=3
        )
        ...
        displayMessageLabel = ttk.Label(
            mdpFrame, textvariable=displayMessage, anchor="center", font=self.bold_font
        )
